    ...
    <section class="header">
        <section class="header-inner">
            ...
            <div id="app-download">
                ...
                <div class="qtcode">
                    <img src="@/assets/QtCode.png" alt="">
                    <p>扫码下载APP</p>
                    <span>选座更优惠</span>
                </div>
            </div>
            <div class="search-inner">
                <input type="search" class="search" placeholder="找影视剧、影人、影院" autocomplete="off" maxlength="32">
                <input type="submit" class="submit" value=" ">
            </div>
            <div class="user">
                <img src="https://p0.meituan.net/movie/7dd82a16316ab32c8359debdb04396ef2897.png" alt="">
                <span class="caret"></span>
            </div>
        </section>
